...
11. **Use public sources only.** Do not bypass paywalls, login walls, robots rules, or access controls. Mark blocked evidence as unverifiable.

## What This Skill Does NOT Do

- It does not check SEO quality
