...
- `[product category] tools [current year]` — landscape context
...
3. The most useful next research or content task based on the gaps found
...
6. **Use public sources only** — do not bypass login walls, paywalls, robots rules, or access controls.
7. **Keep an evidence trail** — include a Sources section with the URLs used and the date accessed.
